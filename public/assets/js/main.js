    ...
    $form.validate({
      ...
      submitHandler: function(form) {
        $(form).ajaxSubmit({
          ...
          error: function(data) {
            $formNotify.removeClass('valid').addClass('error').html('<i class="fa fa-warning"></i>Problema de conexión favor probar de nuevo!').show();
          },
        });
      ...
      invalidHandler: function(event, validator) {
        ...
        if (errors) {
          ...
          '<i class="fa fa-warning"></i>Favor Corrige el error en el formulario para continuar.' :
          '<i class="fa fa-warning"></i>Favor Corrige los ' + errors + ' errores en el formulario para continuar';
